...
function Home() {
  ...
  return (
    <div className=" min-h-screen w-[calc(100%)] ">
      <Navbar/>
  ...
  >
    ...
    Your browser does not support the video tag.
      ...
      <div className="mx-auto max-w-screen-md py-12 relative z-10">
        ...
        <Typography variant="h2" color="white" className="font-bold text-4xl font-serif text-center text-white mb-2  " style={{ fontFamily: ' "DM Serif Display", "Open Sans", "PT Sans", sans-serif' ,marginTop: '80px', }}>
          Tired of making legal documents?
        </Typography>
        <Typography color="white" className="font-normal text-center" style={{fontFamily: '  "PT Sans", sans-serif' }}>
