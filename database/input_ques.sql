...
(29, "Number of days after which Purchaser Advocate should report", "number", "purchaser_report_days"), 
...
(43, "Deadline for Publishing the Book in Months", "number", "publish_deadline"), (44, "Royalty", "number", "royalty"), (45, "Lendor's Address", "text", "lendor_addr"),
(46, "Lendor's Company", "text", "lendor_company"), (47, "Borrower's Company", "text", "borrower_company"), (48, "Borrower's Address", "text", "borrower_addr"),
(49, "Amount to be paid as Capital", "number", "amount"), (50, "Days to repay the Loan")
(58, "How often shall the Publisher submit a statement of sales to the Author", "number", "publish_report"), 
(59, "Number of free copies to be sent to the Author", "number", "no_of_copies_to_author"), (60, "Maximum copies to be sent to the media", "number", "media_copies_limit"),
(61, "Maximum number of copies to be printed", "number", "print_limit"), (62, "Maximum Price of the Book on Sale", "number", "print_max_price"), 
